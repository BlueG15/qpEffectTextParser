...
class genericIfModule extends mod_1.mod {
    constructor() {
        super(...arguments);
        this.cmdName = ['if'];
    ...
    evaluate(cmd, args, option, raw) {
        ...
        if (condition instanceof component_1.component) {
            if (type == "string") {
                if (condition.id != component_1.componentID.text)
                    return [];
                if (condition.str.length == 0)
                    isCondFalse = true;
            }
            else if (type != "auto") {
                if (condition.id != component_1.componentID.number)
                    return [];
                ...
                else if (condition.id == component_1.componentID.text) {
                    if (condition.str.length == 0)
                        isCondFalse = true;
                }
                else
        ...
        else if (condition.length == 1 && condition[0] instanceof component_1.component) {
            if (type == "string") {
                if (condition[0].id != component_1.componentID.text)
                    return [];
                if (condition[0].str.length == 0)
                    isCondFalse = true;
            }
            else if (type != "auto") {
                if (condition[0].id != component_1.componentID.number)
                    return [];
                ...
                else if (condition[0].id == component_1.componentID.text) {
                    if (condition[0].str.length == 0)
                        isCondFalse = true;
                }
                else
        ...
        return ((children[pi] instanceof component_1.component) ? [children[pi]] : children[pi]);
    }
}
