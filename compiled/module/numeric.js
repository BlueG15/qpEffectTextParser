...
class numericModule extends mod_1.mod {
    constructor() {
        super(...arguments);
    ...
    evaluate(cmd, args, option, raw) {
        ...
        try {
            ...
            return [new component_1.numberComponent(NaN, a.message, cmd, raw)];
        }
        let res;
        try {
        ...
        return [new component_1.numberComponent(res, undefined, cmd, raw)];
    }
}
