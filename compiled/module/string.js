...
class stringParseModule extends mod_1.mod {
    constructor() {
        super(...arguments);
        this.cmdName = ['string'];
    ...
    evaluate(cmd, args, option, raw) {
        ...
        try {
            ...
            return [new component_1.textComponent((option.mode == options_1.mode.debug) ? "Cannot parsed" : "", a.message, cmd, raw)];
        }
        let res;
        try {
        ...
        return [new component_1.textComponent(res, undefined, cmd, raw)];
    }
}
